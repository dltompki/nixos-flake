{
  ...
  xdg.desktopEntries."cs2-optimized" = {
    ...
    exec = "env SDL_VIDEO_DRIVER=wayland gamemoderun gamescope -W 3440 -H 1440 -w 2560 -h 1440 -f -r 165 --force-composition --expose-wayland -- steam -applaunch 730 -vulkan -novid -nojoy +engine_low_latency_sleep_after_client_tick true +fps_max 0";
    icon = "steam_icon_730";
    terminal = false;
    categories = ["Game"];
  };
